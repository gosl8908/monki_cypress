...
describe('Onprem Dashboard Test', () => {
    ...
    it('Ceo Page Test', () => {
        ...
        cy.get(':nth-child(1) > .input-group > .form-control').type(Cypress.env('TestId4'));
        cy.get(
        ...
        //     cy.mount('[id="vueAgencyModal"]');

        //     // let myVue2 = document.getElementById('vueAgencyModal');
        //     let myVue2 = cy.get('[id="vueAgencyModal"]');
        //     cy.log(myVue2);

        //     let myVue3 = myVue2.__vue__;

        // // let myVue2 = document.getElementById('vueAgencyModal').__vue__._data.form;
        // cy.log(myVue3);
        // // let myVue2 = document.getElementById('vueAgencyModal');
        // cy.wrap(myVue2).then(vueData => {
        //     vueData.road_address = addressNames.join(', ');
        // });
        // cy.window().then(win => {
        // // Cypress가 페이지의 window 객체에 접근할 수 있게 합니다.
        // const vueInstance = win.vueAgencyModal; // Vue 인스턴스에 접근
        //     vueInstance.$data.form.road_address['road_address'] = addressNames;
        // });
